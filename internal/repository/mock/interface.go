...
func (m *MockIRepository[T]) GetAll() ([]T, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIRepositoryMockRecorder[T]) GetAll() *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIRepository[T]) Load(id int) (*T, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIRepositoryMockRecorder[T]) Load(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Load", reflect.TypeOf((*MockIRepository[T])(nil).Load), id)
}
